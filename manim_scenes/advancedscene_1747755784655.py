...
class AdvancedScene_1747755784655(Scene):
    def construct(self):
        llm_error_msg_str = "API request failed: 520 Server Error:  for url: https://api.groq.com/openai/v1/chat/completions" 
