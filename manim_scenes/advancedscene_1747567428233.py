...
class AdvancedScene_1747567428233(Scene):
    def construct(self):
        ...
        try:
            main_shape_obj = Square(color=RED)
        ...
        self.play(main_shape_obj.animate.shift(UP*1.0))
        self.play(main_shape_obj.animate.set_color(BLUE))
